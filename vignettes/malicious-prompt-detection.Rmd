...
Before proceeding, ensure you have installed graniteR and its Python dependencies. **We strongly recommend using UV for fast dependency installation** (1-2 minutes instead of 10-20 minutes with pip):
...
See the "Getting Started" vignette for detailed installation instructions.
