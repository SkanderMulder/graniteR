...
# Option 1: Sample dataset (12,913 rows, faster for experimentation)
data(malicious_prompts_sample, package = "graniteR")
prompts <- malicious_prompts_sample

# Option 2: Full dataset (373,646 rows, recommended for production models)
...
For this tutorial, we use the sample dataset for faster execution. For production models, use `malicious_prompts_full` which contains 373,646 labeled examples.
...
# Increase batch_size to 16 or 32 if you have sufficient GPU memory
